...
export const blogPostURLS: Blog_Post_URL_Props = {
  ...
  THANGALAAN_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/Thangalaan`,
  THANGALAAN_RELATIVE: "/telugu-movies/Thangalaan",

  LUCKY_BASKHAR_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/Lucky-Baskhar`,
  LUCKY_BASKHAR_RELATIVE: "/telugu-movies/Lucky-Baskhar",

  KANGUVA_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/Kanguva`,
  KANGUVA_RELATIVE: "/telugu-movies/Kanguva",

  KA_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/KA`,
  KA_RELATIVE: "/telugu-movies/KA",

  HARIKATHA_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/Harikatha`,
  HARIKATHA_RELATIVE: "/telugu-movies/Harikatha",

  JIGRA_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/Jigra`,
  JIGRA_RELATIVE: "/telugu-movies/Jigra",

  MECHANIC_ROCKY_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/Mechanic-Rocky`,
  MECHANIC_ROCKY_RELATIVE: "/telugu-movies/Mechanic-Rocky",
  ...
  POTTEL_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/pottel`,
  POTTEL_RELATIVE: "/telugu-movies/pottel",

  LEELA_VINODHAM_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/leela-vinodham`,
  LEELA_VINODHAM_RELATIVE: "/telugu-movies/leela-vinodham",

  ZEBRA_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/zebra-telugu-movie`,
  ZEBRA_RELATIVE: "/telugu-movies/zebra-telugu-movie",

  SIR_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/sir-telugu-movie`,
  SIR_RELATIVE: "/telugu-movies/sir-telugu-movie",

  BACHHALA_MALLI_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/bachhala-malli`,
  BACHHALA_MALLI_RELATIVE: "/telugu-movies/bachhala-malli",

  GAME_CHANGER_ABSOLUTE: `${BASE_URLS.TELUGU_MOVIES_PAGE_BASE_URL}/game-changer-telugu-movie`,
  GAME_CHANGER_RELATIVE: "/telugu-movies/game-changer-telugu-movie",
};
...
export const SEO_OBJ: SEO_OBJ_Props = {
  ...
  TELUGU_MOVIES_PAGE: {
    ...
    title: "iBOMMA- Watch Telugu Movie in HD Quality For Free.",
    description:
      "Here at iBOMMA, you can watch and download recently released telugu movies in hd quality for free of cost. You can directly watch and download hd telugu movies without any registration or signup.",
    lastUpdateTime: `${dynamicLastUpdatedTime()}`,
